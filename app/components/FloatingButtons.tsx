...
const FloatingButtons = () => {
  ...
  return (
    <div
      className="fixed right-4 flex flex-col space-y-4 transition-all duration-300 z-50" // Añadido z-50
      style={{ bottom: `${offsetBottom}px` }} // Ajusta dinámicamente la posición
    >
      {/* Botón de Llamar */}
      <a
        href="tel:+573136114707"
        className="relative group bg-red-500 text-white p-4 rounded-full shadow-lg flex items-center justify-center hover:bg-red-600 transition"
